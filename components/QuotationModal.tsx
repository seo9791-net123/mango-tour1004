...
위 내용으로 상담을 신청합니다.`;
  ...
  return (
    <div className="fixed inset-0 bg-black/60 flex items-start md:items-center justify-center z-[10000] p-0 backdrop-blur-sm print:p-0 print:block print:bg-white print:static pt-12 md:pt-0">
      <div className="printable-area bg-white w-full max-w-4xl h-full md:h-[95vh] md:max-h-[95vh] overflow-hidden shadow-2xl relative flex flex-col print:h-auto print:shadow-none print:w-full print:max-w-none">
        ...
        <div className="no-print bg-gray-100 p-3 pb-20 md:pb-4 border-t flex justify-between md:justify-end gap-2 sticky bottom-0 z-20 shadow-inner">
          <button 
            onClick={onClose} 
            className="flex-1 md:flex-none px-2 md:px-6 py-3 rounded-lg border border-gray-300 text-gray-700 font-bold hover:bg-white transition text-lg md:text-xl whitespace-nowrap"
          >
            닫기
          </button>
          {product && (
            <button 
              ...
              className="flex-1 md:flex-none px-2 md:px-6 py-3 rounded-lg bg-deepgreen text-white font-bold hover:bg-green-800 shadow-lg flex items-center justify-center gap-1 md:gap-2 transition transform hover:-translate-y-0.5 text-lg md:text-xl whitespace-nowrap"
            >
          ...
          <button 
            ...
            className="flex-1 md:flex-none px-2 md:px-6 py-3 rounded-lg bg-gold-500 text-white font-bold hover:bg-gold-600 shadow-lg flex items-center justify-center gap-1 md:gap-2 transition transform hover:-translate-y-0.5 text-lg md:text-xl whitespace-nowrap"
          >
