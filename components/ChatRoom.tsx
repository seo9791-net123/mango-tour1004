...
const ChatRoom: React.FC<Props> = ({ user, onReqLogin, isOpen, onClose }) => {
  ...
  return (
    <div className="fixed bottom-20 md:bottom-6 right-4 md:right-6 w-[calc(100%-2rem)] md:w-96 bg-white rounded-2xl shadow-2xl border border-gray-200 z-[10000] flex flex-col overflow-hidden max-h-[60vh] md:max-h-[600px] animate-fade-in-up no-print">
      {/* Header */}
